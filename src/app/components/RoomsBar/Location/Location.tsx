...
export default function Location({ id, name }: Place) {
  ...
  return (
    <div>
      <div className="border border-neutral-400 font-bold p-2 flex text-center justify-between items-center rounded-l-lg rounded-tr-lg hover:shadow-[0px_0px_4px_1px] hover:shadow-neutral-200 hover:cursor-pointer">
        {name}
        <MdArrowDropUp className="text-2xl" />
      </div>
      <div className="ml-1.5 border-x border-b border-neutral-400 rounded-b-md flex flex-col">
